...
public class Board {
	...
	private Board(int totalPlayer) {
		...
		PlayerInterface p1 = new FastRunnerPlayer(players[0]);
		PlayerInterface p2 = new LuckyCharmPlayer(players[players.length - 1]);
	...
	public static Board getInstance(int totalPlayer) {
		if (instance == null) {
			instance = new Board(totalPlayer);
		}
		return instance;
	}
